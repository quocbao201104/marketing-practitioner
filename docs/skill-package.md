...
Download the [v1.7.2 skill ZIP](https://github.com/quocbao201104/marketing-practitioner/releases/download/v1.7.2/marketing-practitioner.zip), or build from the tagged source using the command below. The host-specific import limits below still apply.
