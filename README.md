...
The current index validates at **264 routes / 253 evidence sources**. Evidence files state what a source **supports** and **does not support**; those bounds are part of claim control.
